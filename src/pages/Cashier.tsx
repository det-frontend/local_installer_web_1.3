  ...
  return (
    <div className=" bg-primary-color h-[100svh] ">
      ...
      <div className="container px-20 mx-auto  h-[80%] flex flex-col justify-center items-center">
        <h3 className=" text-[4vh] text-slate-200 font-extralight">
          Add A Cashier
        </h3>
        {valid && (
          <p className=" font-bold text-red-600  uppercase flex items-center  gap-3 text-[3vh] mt-[10px] mb-[20px]">
            <FcInfo /> Information Needs!
          </p>
        )}
        {success && (
          <p className=" font-bold text-green-600  uppercase flex items-center  gap-3 text-[3vh] mt-[10px] mb-[20px]">
            <FcInfo />
            Success!
          </p>
        )}
