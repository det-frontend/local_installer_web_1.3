  ...
  return (
    ...
    >
      <div className=" px-[90px] py-[40px] justify-between flex ">
        <div>
          <div className="flex text-white flex-col text-[4.5vh] gap-[10px] mt-[80px]">
            <p className=" text-[14px] border-b-[1px] border-slate-400">Add</p>
            {navItems.map((item, index) => (
              ...
              >
                <Link
                  ...
                  onClick={item.href === "/" ? handleLogout : () => {}}
                  to={item.href}
                >
